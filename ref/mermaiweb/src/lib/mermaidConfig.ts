...
export interface MermaidTheme {
  name: string;
  // label and description will be handled by i18n
  config: {
    theme: string;
...
export const initializeMermaid = (themeName: string = 'modern-blue') => {
  const selectedTheme = mermaidThemes.find((t) => t.name === themeName) || mermaidThemes[0];
